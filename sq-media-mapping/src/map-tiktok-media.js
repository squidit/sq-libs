...
function mapTiktokMediaToSquidMedia (tiktokMedia) {
  ...
  const mappedMedia = {
    ...
    tipo: 'video',
    upvotes: get(tiktokMedia, 'like_count', 0),
    comentarios: get(tiktokMedia, 'comment_count', 0),
    criadoEm,
    lastUpdate: new Date(),
    ...
    metadados: {
      views: get(tiktokMedia, 'view_count', 0),
      likes: get(tiktokMedia, 'like_count', 0),
      comments: get(tiktokMedia, 'comment_count', 0),
